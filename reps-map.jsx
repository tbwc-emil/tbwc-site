...
const AGENCIES = [
  { id: 'usnw',     name: 'U.S. Northwest',          contact: 'Kevin Adams',     phone: '(503) 624-8293', region: 'Pacific Northwest', territories: 'WA · OR · ID · MT · AK',        states: ['WA','OR','ID','MT','AK'],          logo: 'rep_logos/usnw.png' },
  { id: 'dz',       name: 'DZ Associates',           contact: 'Steve Mobley',    phone: '(510) 293-6810', region: 'Pacific',           territories: 'NV · HI · Northern California',  states: ['NV','HI'],                          logo: 'rep_logos/dz.png' },
  { id: 'ba',       name: 'BA Sales',                contact: 'James Blanchard', phone: '(909) 974-0111', region: 'Pacific',           territories: 'Southern California',            states: ['CA'],                                logo: 'rep_logos/ba.png' },
  { id: 'intriq',   name: 'Intriq',                  contact: 'Mark Jeffrey',    phone: '(303) 758-5530', region: 'Mountain',          territories: 'CO · UT · WY · NM · AZ',         states: ['CO','UT','WY','NM','AZ'],            logo: 'rep_logos/intriq.png' },
  { id: 'meglio',   name: 'Meglio Sales',            contact: 'Dave Meglio',     phone: '(314) 524-4424', region: 'Central',           territories: 'MO · KS · NE · ND · SD · AR',    states: ['MO','KS','NE','ND','SD','AR'],       logo: 'rep_logos/meglio.png' },
  { id: 'mercer',   name: 'Mercer & Associates',     contact: 'Steve Mercer',    phone: '(920) 915-6223', region: 'Central',           territories: 'WI · MN · IA',                   states: ['WI','MN','IA'],                      logo: 'rep_logos/mercer.png' },
  { id: 'am',       name: 'AM Sales',                contact: 'Ray Doerrer',     phone: '(630) 501-0880', region: 'Great Lakes',       territories: 'IL · IN',                        states: ['IL','IN'],                            logo: 'rep_logos/am.png' },
  { id: 'pt',       name: 'PT Sales',                contact: 'Ken Piron',       phone: '(248) 291-6213', region: 'Great Lakes',       territories: 'MI · OH',                        states: ['MI','OH'],                            logo: 'rep_logos/pt.png' },
  { id: 'invictus', name: 'Invictus',                contact: 'Bill Holton',     phone: '(540) 239-1033', region: 'Mid-Atlantic',      territories: 'KY · WV · TN',                   states: ['KY','WV','TN'],                       logo: 'rep_logos/invictus.png' },
  { id: 'phoenix',  name: 'Phoenix Tech',            contact: 'Bob Fern',        phone: '(703) 282-4597', region: 'Mid-Atlantic',      territories: 'VA · MD · DC · DE',              states: ['VA','MD','DC','DE'],                  logo: 'rep_logos/phoenix.png' },
  { id: 'pollart',  name: 'Pollart Sales',           contact: 'Eric Vogelsong',  phone: '(609) 238-8414', region: 'Mid-Atlantic',      territories: 'NJ · PA',                        states: ['NJ','PA'],                            logo: 'rep_logos/pollart.png' },
  { id: 'damin',    name: 'Damin Sales',             contact: 'Justin Felber',   phone: '(917) 414-0098', region: 'Northeast',         territories: 'New York',                       states: ['NY'],                                 logo: 'rep_logos/damin.png' },
  { id: 'sss',      name: 'SSS — Strategic Sales',   contact: "Jay O'Connor",    phone: '(508) 326-2708', region: 'Northeast',         territories: 'MA · CT · RI · ME · NH · VT',    states: ['MA','CT','RI','ME','NH','VT'],         logo: 'rep_logos/sss.png' },
  { id: 'ues',      name: 'UES Group',               contact: 'Tom Holcombe',    phone: '(336) 803-8338', region: 'Southeast',         territories: 'NC · SC · GA · FL · AL · MS',    states: ['NC','SC','GA','FL','AL','MS'],         logo: 'rep_logos/ues.png' },
  { id: 'bellmccoy',name: 'Bell & McCoy',            contact: 'Scott Thomas',    phone: '(972) 489-2879', region: 'South Central',     territories: 'TX · LA · OK',                   states: ['TX','LA','OK'],                       logo: 'rep_logos/bellmccoy.png' },
];
